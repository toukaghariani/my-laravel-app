                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link wn-nav-link" href="{{ url('/favorites') }}">
                                <i class="bi bi-heart-fill text-danger"></i> My List
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu wn-dropdown">
                                <li><a class="dropdown-item wn-dropdown-item" href="{{ url('/profile') }}">Profile</a></li>
                                <li><hr class="dropdown-divider wn-divider"></li>
                                <li>
                                    <form action="{{ url('/logout') }}" method="POST">
                                        @csrf
                                        <button class="dropdown-item wn-dropdown-item" type="submit">Logout</button>
                                    </form>
                                </li>
                            </ul>
                        </li>
